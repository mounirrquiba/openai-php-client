 ...
 */
final class FileContent extends AbstractService
{
    /**
     * {@inheritdoc}
     */
    public const OPENAI_DECODE_RESPONSE = false;
     ...
     * {@inheritdoc}
     */
    public const OPENAI_ENDPOINT = '/files/{' . self::OPENAI_ID_NAME . '}/content';
